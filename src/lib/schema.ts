...
// Task Types for Provider Manager Tasks
...
export type TaskStatus = "Pending" | "InProgress" | "Completed" | "Cancelled" | "Deferred";

export type TaskPriority = "Low" | "Medium" | "High" | "Urgent";

export const TASK_STATUS_CODES: Record<TaskStatus, number> = {
  "Pending": 0,
  "InProgress": 1,
  "Completed": 2,
  "Cancelled": 3,
...
export const TASK_PRIORITY_CODES: Record<TaskPriority, number> = {
  "Low": 0,
  "Medium": 1,
  "High": 2,
  "Urgent": 3,
...
export interface Task {
  ...
  // Related Entity (the entity this task is about)
  relatedEntityType?: "Student" | "Property" | "Payment" | "Ticket" | "Document";
  relatedEntityId?: string;          // ID of the related entity
  relatedEntityName?: string;        // Display name for quick reference
  
  // Assignment
  assignedToUserId?: string;         // FK → User (who should complete this task)
  ...
  // Resolution
  resolution?: string;               // Notes on how task was resolved
  ...
  // Auto-generated tasks flag
  isAutoGenerated?: boolean;         // True if system-generated (e.g., from student approval request)
}
